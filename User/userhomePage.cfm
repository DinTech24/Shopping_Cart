...
<html lang="en">
    ...
    <body>
        <cfoutput>
            ...
            <div class="subcategoryBar py-1 px-2">
                <cfloop query="categoryResult">
                    <div class="subCategoryEach">
                        <cfset subCategoryResult = userHomeObject.listSubCategories(categoryResult.fldcategory_ID)>
                        #categoryResult.fldcategoryName#
                        <div class="toolTipData">
                            <cfloop query="subCategoryResult">
                            <div class="my-2">
                                <a href="" class="text-decoration-none">#subCategoryResult.fldSubCategoryName#</a>
                            </div>
                            </cfloop>
                        </div>
                    </div>
            ...
            <div>
                <img class="mainImage" src="../Assets/SiteImages/SiteMainImage.png" alt="mainImage">
            </div>
            <div>
                <div>
                    <div class="randomProductsHead">Random Products</div>
                        ...
                        <cfloop query="randomProductsResult">
                            <div class="card randomProductCard" style="width: 13rem;">
                                ...
                                <div class="card-body randProductbody">
                                    ...
                                    <div class="card-text randProductPrice">#randomProductsResult.fldPrice + randomProductsResult.fldTax#</div>
                                </div>
                            </div>
                        </cfloop>
                    </div>
