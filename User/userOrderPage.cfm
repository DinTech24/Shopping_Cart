        ...
        <cfoutput>
            ...
            <div class="cartPageMain" id="cartPageMainId">
                <div class="productDescription accordion" id='accordionMain'>
                    <div>
                        <button class=" deliveryAddressDiv accordion-item accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="##collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            Delivery Address
                        </button>
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="##accordionMain">
                            ...
                            <div class='d-flex addressSubDiv py-2 '>
                                <input class="ms-2" name="addressSelect" type="radio" value="#addressDeatils.fldAddress_ID#">
                    ...
                    <div>
                        <button class=" deliveryAddressDiv accordion-item accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="##collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                            Order Summary
                        </button>
                            ...
                            <cfif structKeyExists(url, "productId")>
                                <div class="mainSectionBody">
                                    ...
                                    <div class="d-flex w-50 ms-4 mt-2 justify-content-between mb-3">
                                            <div>
                                                <button class="prquanityIncrease" disabled id="reduceQuantity" onclick="reduceBuyQuantity()">-</button>
                                                <span class="prquanity" id="ProductQuantitySpan">1</span>
                                                <button class="prquanityIncrease" id="addProductButton" onclick="addBuyQuantity()">+</button>
                                            </div>
                                        </div>
                                </div>
                                <cfelse>
                    ...
                    <div class="w-100 placeOrderDiv">
                        <div class="placeOrderButton">CONTINUE TO PAYMENT</div>
                    </div>
                </div>
